...
from o_settings import Settings
from o_components import Board, GameEnded
from src.observers import Observable, Observer
...
class Game:
    """
    Main class representing a Tetris game. Settings are loaded from o_settings.py #
    """
